...
\subsubsubsubsection{Processo de atendimento adotado}
...
\subsubsubsubsection{Avaliação multifatorial do grau de urgência}
...
\subsubsubsubsection{Classificação das urgências}
