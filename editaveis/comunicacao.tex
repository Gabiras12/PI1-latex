\subsection{Sistema de Comunicação via Rádio Frequência}
...
O MAVLink - \textit{Micro Air Vehicle Message Marshalling Library} - é uma biblioteca de comunicação para 
...
\subsection{Especificação do Projeto da Comunicação do Vant}
...
\subsubsection{Comunicação com o Pixhawk}
...
\begin{figure}[h!]
    \centering
	    \includegraphics[keepaspectratio=true,scale=0.5]{figuras/planovoo.png}
...
\begin{figure}[h!]
    \centering
	    \includegraphics[keepaspectratio=true,scale=0.8]{figuras/esplanada.png}
...
\subsubsection{Comunicação do usuário com o VANT}
